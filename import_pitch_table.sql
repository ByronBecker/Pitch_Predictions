...
Load data local infile '~/myDesktop/CS_Courses/Sabermetrics/Project/pfx_parser/first_2months_pitch_2017.csv' into table pitch_table_fx
...
select * from pandas_pitch_export limit 3000;
